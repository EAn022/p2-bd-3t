...
class Medico(Funcionario):
    def __init__(self, id, id_funcionario, id_pessoa, salario, cargo, nome, CPF, data_nasc, crm, especialidade):
        super().__init__(id_funcionario, id_pessoa, salario, cargo, nome, CPF, data_nasc)
        self._id = id  
